...
<body id="index_menu" class="body-atualizar">
    ...
    <main class="main-menu">
        ...
        <section>    
            ...
            <div>
                <form method="post" action="<?= URL_BASE?>index.php?url=cadastro">
                    ...
                    <label for="telefone_emergencia">Telefone para emergências:</label>
